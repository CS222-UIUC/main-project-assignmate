...
urlpatterns = [
    ...
    path('api/courses/<int:course_id>/assignments/',
         AssignmentsByCourseView.as_view(), name='assignments'),
    path('api/courses/<int:course_id>/assignments/<int:assignment_id>/',
         AssignmentByIdView.as_view(), name='assignment'),
]
